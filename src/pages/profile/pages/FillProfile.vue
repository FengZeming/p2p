<template>
  <div>
    <group>
      ...
      <x-input title="地址" :max="30" placeholder="请输入收货地址"></x-input>
      <x-input title="邮编" :max="5" placeholder="请输入邮编" type="number"></x-input>
    </group>
    <x-button style="margin-top: 30px; width: 80%;">提交</x-button>
