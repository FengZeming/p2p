<template>
  <tabbar slot="bottom" style="position: fixed;">
    ...
    <!--</tabbar-item>-->
    <!--&lt;!&ndash;<tabbar-item :link="{path:'/iframe'}" :selected="routePath =='/iframe'" v-if="isP2p(routePath)">&ndash;&gt;-->
      <!--&lt;!&ndash;<i slot="icon" class="icon iconfont icon-iconfontxingxing"></i>&ndash;&gt;-->
      <!--&lt;!&ndash;<span slot="label">我的</span>&ndash;&gt;-->
